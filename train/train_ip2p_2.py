...
resume_path = '/mnt/Data/musa7216/cnet_results/models/control_v11e_sd15_ip2p.pth'
sd_path = '/mnt/Data/musa7216/cnet_results/models/v1-5-pruned.ckpt'
cfg_path = '/mnt/Data/musa7216/cnet_results/models/control_v11e_sd15_ip2p.yaml'
batch_size = 8
accu_grad = 16
logger_freq = 1000
learning_rate = 1e-5
...
# Misc
dataset = BDD_10K_Dataset(data_dir=data_dir, mode="train", seed=seed, preprocess="ip2p")
dataset_val = BDD_10K_Dataset(data_dir=data_dir, mode="val", seed=seed, preprocess="ip2p")
dataloader = DataLoader(dataset, num_workers=0, batch_size=batch_size, shuffle=True)
dataloader_val = DataLoader(dataset_val, num_workers=0, batch_size=batch_size, shuffle=False)

logger = ImageLogger(batch_frequency=logger_freq)
trainer = pl.Trainer(accelerator="gpu", devices=[0], accumulate_grad_batches=accu_grad, 
