...
resume_path = '/mnt/Data/musa7216/cnet_results/models/control_v11p_sd15_canny.pth'
sd_path = '/mnt/Data/musa7216/cnet_results/models/v1-5-pruned.ckpt'
cfg_path = '/mnt/Data/musa7216/cnet_results/models/control_v11p_sd15_canny.yaml'
batch_size = 8
accu_grad = 16
logger_freq = 1000
learning_rate = 1e-5
...
# Misc
dataset = BDD_10K_Dataset(data_dir=data_dir, mode="train", preprocess="canny")
dataset_val = BDD_10K_Dataset(data_dir=data_dir, mode="val", preprocess="canny")
